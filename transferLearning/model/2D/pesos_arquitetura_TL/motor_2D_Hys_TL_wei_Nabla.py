...
for unlock in unlock_layers_list:
    ...
    for seed in range(seeds):
        ...
        print(f"seed: {seed +1} || MAPE 100% = {Hys_mape}  RMSE 100% = {Hys_rmse}")
        ...
        contents = [b_TL_neurons,b_TL_layers,b_TL_lr,unlock,epochs,Hys_score,Hys_mse,Hys_rmse,Hys_mape,elapsed_time]
